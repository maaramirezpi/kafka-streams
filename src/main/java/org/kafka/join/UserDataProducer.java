...
public class UserDataProducer {
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        // prints Purchase=Apples and Bananas (1),UserInfo=[First=John,Last=Doe,Email=john.doe@gmail.com]
        System.out.println("\nExample 1 - new user\n");
        ...
        // prints Purchase=Oranges (3),UserInfo=[First=Johnny,Last=Doe,Email=johnny.doe@gmail.com]
        ...
        // prints Purchase=Computer (4),UserInfo=null
        // prints Purchase=Computer (4),UserInfo=[First=Stephane,Last=Maarek,GitHub=simplesteph]
        // prints Purchase=Books (4),UserInfo=[First=Stephane,Last=Maarek,GitHub=simplesteph]
        // prints Purchase=Books (4),UserInfo=null
